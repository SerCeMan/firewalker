...
lib.wirefilter_set_panic_catcher_fallback_mode = [wirefilter_boolean_result_t, [ref.types.uint8]];
...
lib.wirefilter_free_scheme = [ref.types.void, [ref.refType(wirefilter_scheme_t)]];

// wirefilter_type_t wirefilter_create_map_type(wirefilter_type_t type);

lib.wirefilter_create_map_type = [wirefilter_type_t, [wirefilter_type_t]];

//
// wirefilter_type_t wirefilter_create_array_type(wirefilter_type_t type);

lib.wirefilter_create_array_type = [wirefilter_type_t, [wirefilter_type_t]];
...
lib.wirefilter_add_type_field_to_scheme = [
  ref.types.bool,
  [ref.refType(wirefilter_scheme_t), wirefilter_externally_allocated_str_t, wirefilter_type_t],
];
...
lib.wirefilter_add_type_list_to_scheme = [
  ref.types.bool,
  [ref.refType(wirefilter_scheme_t), wirefilter_type_t, ref.refType(wirefilter_list_t)],
];
...
lib.wirefilter_parse_filter = [
  wirefilter_parsing_result_t,
  [ref.refType(wirefilter_scheme_t), wirefilter_externally_allocated_str_t],
];

// void wirefilter_free_filter_ast(wirefilter_filter_ast_t *ast);

lib.wirefilter_free_filter_ast = [ref.types.void, [ref.refType(wirefilter_filter_ast_t)]];

//
// void wirefilter_free_parsing_result(wirefilter_parsing_result_t result);

lib.wirefilter_free_parsing_result = [ref.types.void, [wirefilter_parsing_result_t]];

// wirefilter_compiling_result_t wirefilter_compile_filter(wirefilter_filter_ast_t *ast);

lib.wirefilter_compile_filter = [
  wirefilter_compiling_result_t,
...
lib.wirefilter_compile_filter = [ref.types.void, [wirefilter_compiling_result_t]];

// void wirefilter_free_compiling_result(wirefilter_compiling_result_t result);

lib.wirefilter_free_compiling_result = [ref.types.void, [wirefilter_compiling_result_t]];
...
lib.wirefilter_free_compiled_filter = [ref.types.void, [ref.refType(wirefilter_filter_t)]];
...
lib.wirefilter_create_execution_context = [
...
lib.wirefilter_free_execution_context = [
  ref.types.void,
  [ref.refType(wirefilter_execution_context_t)],
];
...
lib.wirefilter_add_int_value_to_execution_context = [
  ref.types.bool,
  [
    ref.refType(wirefilter_execution_context_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_add_bytes_value_to_execution_context = [
  ref.types.bool,
  [
    ref.refType(wirefilter_execution_context_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_add_ipv6_value_to_execution_context = [
  ref.types.bool,
  [
    ref.refType(wirefilter_execution_context_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_add_ipv4_value_to_execution_context = [
  ref.types.bool,
  [
    ref.refType(wirefilter_execution_context_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_add_bool_value_to_execution_context = [
  ref.types.bool,
  [
    ref.refType(wirefilter_execution_context_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_add_map_value_to_execution_context = [
  ref.types.bool,
  [
    ref.refType(wirefilter_execution_context_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_add_array_value_to_execution_context = [
  ref.types.bool,
  [
    ref.refType(wirefilter_execution_context_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_create_map = [ref.refType(wirefilter_map_t), [wirefilter_type_t]];
...
lib.wirefilter_add_int_value_to_map = [
  ref.types.bool,
  [ref.refType(wirefilter_map_t), wirefilter_externally_allocated_str_t, ref.types.int32],
];
...
lib.wirefilter_add_bytes_value_to_map = [
  ref.types.bool,
  [
    ref.refType(wirefilter_map_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_add_ipv6_value_to_map = [
  ref.types.bool,
  [ref.refType(wirefilter_map_t), wirefilter_externally_allocated_str_t, Array(ref.types.uint8)],
];
...
lib.wirefilter_add_ipv4_value_to_map = [
  ref.types.bool,
  [ref.refType(wirefilter_map_t), wirefilter_externally_allocated_str_t, Array(ref.types.uint8)],
];
...
lib.wirefilter_add_bool_value_to_map = [
  ref.types.bool,
  [ref.refType(wirefilter_map_t), wirefilter_externally_allocated_str_t, ref.types.bool],
];
...
lib.wirefilter_add_map_value_to_map = [
  ref.types.bool,
  [
    ref.refType(wirefilter_map_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_add_array_value_to_map = [
  ref.types.bool,
  [
    ref.refType(wirefilter_map_t),
    wirefilter_externally_allocated_str_t,
...
lib.wirefilter_free_map = [ref.types.void, [ref.refType(wirefilter_map_t)]];

//
// wirefilter_array_t *wirefilter_create_array(wirefilter_type_t type);

lib.wirefilter_create_array = [ref.refType(wirefilter_array_t), [wirefilter_type_t]];
...
lib.wirefilter_add_int_value_to_array = [
  ref.types.bool,
  [ref.refType(wirefilter_array_t), ref.types.uint32, ref.types.int32],
];
...
lib.wirefilter_add_bytes_value_to_array = [
  ref.types.bool,
  [ref.refType(wirefilter_array_t), ref.types.uint32, wirefilter_externally_allocated_byte_arr_t],
];
...
lib.wirefilter_add_ipv6_value_to_array = [
  ref.types.bool,
  [ref.refType(wirefilter_array_t), ref.types.uint32, Array(ref.types.uint8)],
];
...
lib.wirefilter_add_ipv4_value_to_array = [
  ref.types.bool,
  [ref.refType(wirefilter_array_t), ref.types.uint32, Array(ref.types.uint8)],
];
...
lib.wirefilter_add_bool_value_to_array = [
  ref.types.bool,
  [ref.refType(wirefilter_array_t), ref.types.uint32, ref.types.bool],
];
...
lib.wirefilter_add_map_value_to_array = [
  ref.types.bool,
  [ref.refType(wirefilter_array_t), ref.types.uint32, ref.refType(wirefilter_map_t)],
];
...
lib.wirefilter_add_array_value_to_array = [
  ref.types.bool,
  [ref.refType(wirefilter_array_t), ref.types.uint32, ref.refType(wirefilter_array_t)],
];
...
lib.wirefilter_match = [
  wirefilter_matching_result_t,
  [ref.refType(wirefilter_filter_t), ref.refType(wirefilter_execution_context_t)],
];
...
lib.wirefilter_filter_uses = [
  wirefilter_using_result_t,
  [ref.refType(wirefilter_filter_ast_t), wirefilter_externally_allocated_str_t],
];
...
lib.wirefilter_filter_uses_list = [
  wirefilter_using_result_t,
  [ref.refType(wirefilter_filter_ast_t), wirefilter_externally_allocated_str_t],
];
...
lib.wirefilter_get_filter_hash = [
  wirefilter_hashing_result_t,
  [ref.refType(wirefilter_filter_ast_t)],
];
...
lib.wirefilter_free_hashing_result = [ref.types.void, [wirefilter_hashing_result_t]];
...
lib.wirefilter_serialize_filter_to_json = [
  wirefilter_serializing_result_t,
  [ref.refType(wirefilter_filter_ast_t)],
];
...
lib.wirefilter_serialize_scheme_to_json = [
  wirefilter_serializing_result_t,
  [ref.refType(wirefilter_scheme_t)],
];
...
lib.wirefilter_serialize_type_to_json = [
  wirefilter_serializing_result_t,
...
lib.wirefilter_serialize_execution_context_to_json = [
  wirefilter_serializing_result_t,
  [ref.refType(wirefilter_execution_context_t)],
];
...
lib.wirefilter_free_serializing_result = [ref.types.void, [wirefilter_serializing_result_t]];

//
// void wirefilter_free_string(wirefilter_rust_allocated_str_t str);

lib.wirefilter_free_string = [ref.types.void, [wirefilter_rust_allocated_str_t]];
...
lib.add_standard_functions = [ref.types.void, [ref.refType(wirefilter_scheme_t)]];

lib.set_all_lists_to_nevermatch = [ref.types.bool, [ref.refType(wirefilter_execution_context_t)]];

lib.wirefilter_setup_int_lists = [
  ref.types.void,
  [ref.refType(wirefilter_execution_context_t), ref.refType(wirefilter_map_t)],
];

lib.wirefilter_setup_ip_lists = [
  ref.types.void,
  [ref.refType(wirefilter_execution_context_t), ref.refType(wirefilter_map_t)],
];
